...
game_path = "./tw_games/playground_quest_7.ulx"
...
for phrase_mode in phrase_modes:
    ...
    tr_avg_scores, _, task_command_no_list, altruistic_command_no_list = play(phrase_mode, agent, gg_model, game_path, max_step=step_size, nb_episodes=3000, verbose=False)
...
file1 = open('result/test_game_action_quest_7_update_fr_2000.txt', 'w') 
