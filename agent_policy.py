...
nutral_command_list = ["wait", "look", "examine", "go north", "go west", "go east", "go south", "drop", "put", "take", "get rid of the game gears"]
...
for phrase_mode in phrase_modes:
    ...
    tr_avg_scores, _, task_command_no_list, altruistic_command_no_list = play(phrase_mode, agent, gg_model, game_path, max_step=step_size, nb_episodes=5000, verbose=False)
...
file1 = open('result/test_game_action_quest_6_update_fr_5000.txt', 'w') 
