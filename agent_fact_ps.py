...
pickle.dump(all_task_specific_command_list, open( "result/task_ratio/task_ps_phrase_1.p", "wb" ) )
pickle.dump(all_altruistic_command_list, open( "result/task_ratio/altruistic_ps_phrase_1.p", "wb" ) )


print("task: ", all_task_specific_command_list)
print("altruism: ", all_altruistic_command_list)
file1 = open('result/ps_test_phrases_1_quest_8_facts_5000.txt', 'w') 
