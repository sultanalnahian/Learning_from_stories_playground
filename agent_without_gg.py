...
def play(phrase_mode, agent, path, max_step=50, nb_episodes=30, verbose=True):
    """
...
phrase_modes = ['Phrase 1', 'Phrase 2', 'Phrase 3']
training_scores = []
testing_scores = []
test_policy_list = []
...
for phrase_mode in phrase_modes:
    ...
    tr_avg_scores, _, task_command_no_list, altruistic_command_no_list, train_no_moves_list = play(phrase_mode, agent, game_path, max_step=step_size, nb_episodes=nb_episodes, verbose=False)
    ...
    test_avg_scores, policy_list, _, _, _ = play(phrase_mode, agent, game_path, max_step=step_size, nb_episodes=50)  # Medium level game.
...
plt.plot(x_plot, all_task_specific_command_list[2], label="task")
plt.plot(x_plot, all_altruistic_command_list[2], label="altruism")
...
pickle.dump(training_scores, open( "result/without_gg/training_scores_phrase_1_2_3.p", "wb" ) )
pickle.dump(all_task_specific_command_list, open( "result/without_gg/task_without_gg_phrase_1_2_3.p", "wb" ) )
pickle.dump(all_altruistic_command_list, open( "result/without_gg/altruistic_without_gg_phrase_1_2_3.p", "wb" ) )

print("task: ", all_task_specific_command_list)
print("altruism: ", all_altruistic_command_list)
file1 = open('result/without_gg/test_playground_phrase_1_2_3_without_gg_quest_8_5000.txt', 'w') 
