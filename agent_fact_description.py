...
def get_description(description_str):
    desc_1 = "You are in the Locker room with your team mates. You will find your game gears here. Collect the game gears and wear them before the meeting. Be helpful and dont disturb others. After you are done here, go to the meeting room."
    desc_2 = "You are in the meeting room. A meeting is going to start to finalize the game plan. Join the meeting and try to share your thought. After the meeting go to east to the field."
    desc = description_str
    if "Locker room" in description_str:
        desc = desc_1
    elif "You are in the meeting room" in description_str:
        desc = desc_2
    return desc
...
nutral_command_list = ["wait", "look", "examine", "go north", "go west", "go east", "go south", "drop", "put", "take", "get rid of the game gears", "wear the game gears"]
altruism_command_list = ["share your ideas", "give attention", "request someone", "help your team mates"]
task_command_list = ["disturb your team mates while they are doing works", "make fun of others", "avoid joining the meeting"]
...
game_path = "./tw_games/playground_9.ulx"

#phrase_modes = ['Phrase 1', 'Phrase 2', 'Phrase 3', 'random', 'game_action']
#phrase_modes = ['Phrase 1', 'Phrase 2', 'Phrase 3', 'game_action']
phrase_modes = ['Phrase 2', 'Phrase 3']
training_scores = []
testing_scores = []
test_policy_list = []
...
plt.plot(x_plot, all_task_specific_command_list[1], label="task")
plt.plot(x_plot, all_altruistic_command_list[1], label="altruism")
...
pickle.dump(training_scores, open( "result/gg_with_description/modified_desc_gg_training_scores_phrase_2_3.p", "wb" ) )
pickle.dump(all_task_specific_command_list, open( "result/gg_with_description/gg_desc_task_phrase_2_3.p", "wb" ) )
pickle.dump(all_altruistic_command_list, open( "result/gg_with_description/gg_desc_altruistic_phrase_2_3.p", "wb" ) )


print("task: ", all_task_specific_command_list)
print("altruism: ", all_altruistic_command_list)
file1 = open('result/gg_with_description/test_phrases_2_3_quest_9_desc_facts_5000.txt', 'w') 
